...
app = App() do
  return DOM.div(
    ...
    meshscatter(rand(Point3f, 10), marker=Pyramid(Point3f(0), 1.0f0, 1.0f0)),
  )
end
...
app = App() do
  ...
  return hbox(vbox(
      Makie.mesh(Circle(Point2f(0), 1.0f0)),
      Makie.poly(decompose(Point2f, Circle(Point2f(0), 1.0f0)))), vbox(
